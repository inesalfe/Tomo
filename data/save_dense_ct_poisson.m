function save_dense_ct_poisson(N_pixels,theta,seed,intensity)
    ...
    fileID = fopen('ct_poisson/params_dense.txt','a+');
    ...
    fileID_error = fopen('ct_poisson/params_dense.txt','a+');
    ...
    filename_idx_non_zero_pixels = "ct_poisson/idx_non_zero_pixels_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + ".bin";
    ...
    filename_is_pixel_zero = "ct_poisson/is_pixel_zero_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + ".bin";
    ...
    filename_x_ls_pos = "ct_poisson/x_ls_pos_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + ".bin";
    file_x_ls_pos = fopen(filename_x_ls_pos,'w');
    fwrite(file_x_ls_pos, x_ls_pos, 'double');
    fclose(file_x_ls_pos);

    filename_x_ls_box = "ct_poisson/x_ls_box_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + ".bin";
    ...
    filename_A = "ct_poisson/A_" + int2str(M) + "_" + int2str(N) + "_" + int2str(seed) + ".bin";
