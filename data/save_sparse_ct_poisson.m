function save_sparse_ct_poisson(N_pixels,theta,seed,intensity,eta)
    ...
    fileID = fopen('ct_poisson/params_sparse.txt','a+');
    ...
    fileID_error = fopen('ct_poisson/params_sparse.txt','a+');
