...
% nohup matlab -nodisplay -nosplash -singleCompThread -batch "run('gen_ct_gaussian_huge.m'); exit" > output3.log 2>&1 &
...
% save_sparse_ct_huge(N,theta,p,d);
% save_sparse_ct_huge(N,theta,p,d/2);
% save_sparse_ct_huge(N,theta,p,2*d);
