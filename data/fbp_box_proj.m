...
% nohup matlab -nodisplay -nosplash -singleCompThread -batch "run('fbp_box_proj.m'); exit" > output8.log 2>&1 &

% nohup /Applications/MATLAB_R2024a.app/bin/matlab -nodisplay -nosplash -singleCompThread -batch "run('fbp_box_proj.m'); exit" > output8.log 2>&1 &
