...
int main (int argc, char *argv[]) {
	...
	string filename_error = "errors/seq_dense/" + matrix_type + "/RK_box_proj_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
	string filename_res = "errors/seq_dense/" + matrix_type + "/RK_box_proj_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
