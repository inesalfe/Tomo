...
int main (int argc, char *argv[]) {
	...
	string filename_error = "errors/seq_dense/CK_pos_ineq_error_" + to_string(M) + "_" + to_string(N) + ".txt";
	string filename_res = "errors/seq_dense/CK_pos_ineq_res_" + to_string(M) + "_" + to_string(N) + ".txt";
