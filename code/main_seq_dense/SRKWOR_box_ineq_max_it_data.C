...
int main (int argc, char *argv[]) {
	...
	if(argc != 7 && argc != 8) {
		...
		cout << "'./bin/SRKWOR_box_ineq_max_it_data.exe <data_set> <n_runs> <M> <N> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = "errors/seq_dense/" + matrix_type + "/SRKWOR_box_ineq_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
	string filename_res = "errors/seq_dense/" + matrix_type + "/SRKWOR_box_ineq_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(max_it_stop);
