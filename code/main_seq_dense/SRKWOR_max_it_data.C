...
int main (int argc, char *argv[]) {
	...
	string filename_error = "errors/seq_dense/SRKWOR_error_" + to_string(M) + "_" + to_string(N) + ".txt";
	string filename_res = "errors/seq_dense/SRKWOR_res_" + to_string(M) + "_" + to_string(N) + ".txt";
