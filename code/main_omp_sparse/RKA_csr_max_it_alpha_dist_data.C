...
int main (int argc, char *argv[]) {
	...
	string filename_error = "errors/omp_sparse/" + matrix_type + "/RKA_alpha_dist_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(it_per_thread) + "_" + str_alpha + "_" + to_string(max_it_stop);
	string filename_res = "errors/omp_sparse/" + matrix_type + "/RKA_alpha_dist_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(it_per_thread) + "_" + str_alpha + "_" + to_string(max_it_stop);
