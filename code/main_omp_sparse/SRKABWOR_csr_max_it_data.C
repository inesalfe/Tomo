...
int main (int argc, char *argv[]) {
	...
	string filename_error = "errors/omp_sparse/SRKABWOR_csr_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(threads) + ".txt";
	string filename_res = "errors/omp_sparse/SRKABWOR_csr_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(threads) + ".txt";
