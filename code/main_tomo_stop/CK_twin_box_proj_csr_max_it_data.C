...
// ./bin/CK_twin_box_proj_csr_max_it_data.exe ct_gaussian 10 19558 16384 10000000 1 2

int main (int argc, char *argv[]) {

	if(argc != 7 && argc != 8) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/CK_twin_box_proj_csr_max_it_data.exe <data_set> <n_runs> <M> <N> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
