...
// ./bin/SRKWOR_shuffle_time.exe ct_gaussian 10 19558 16384 2

int main (int argc, char *argv[]) {

	if(argc != 5 && argc != 6) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/SRKWOR_shuffle_time.exe <data_set> <n_runs> <M> <N>'" << endl;
		exit(1);
	}
	...
	string filename_b;
	string filename_x;
	if (argc == 5 && matrix_type.compare("ct") == 0) {
	...
	else if (argc == 6 && matrix_type.compare("ct_gaussian") == 0) {
	...
	else if (argc == 6 && matrix_type.compare("ct_poisson") == 0) {
		int seed = atoi(argv[5]);
