...
// ./bin/CK_csr_alpha_stop.exe ct_gaussian 10 19558 16384 7 2

int main (int argc, char *argv[]) {

	if(argc != 7 && argc != 8) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/CK_csr_alpha_stop.exe <data_set> <n_runs> <M> <N> <bucket_size> <alpha>'" << endl;
		exit(1);
	}
	...
	string filename_sol = "outputs/tomo_stop/" + matrix_type + "/CK_alpha_sol_" + to_string(M) + "_" + to_string(N) + "_" + str_alpha;
