...
# python3 plots/omp_sparse/RKA.py ct 3112 484 100000
# python3 plots/omp_sparse/RKA.py ct_gaussian 4886 1024 3000000 1
# python3 plots/omp_sparse/RKA.py ct_poisson 4886 1024 100000000 1
...
if (data_set == "ct"):
	...
	output_foler = "/"
	filename_error_1 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + ".txt"
	filename_res_1 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + ".txt"
	filename_error_2 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + ".txt"
	filename_res_2 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + ".txt"
	filename_error_4 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + ".txt"
	filename_res_4 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + ".txt"
	filename_error_8 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + ".txt"
	filename_res_8 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + ".txt"
	filename_error_16 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + ".txt"
	filename_res_16 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + ".txt"
	filename_error_32 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + ".txt"
	filename_res_32 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + ".txt"
	filename_error_64 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + ".txt"
	filename_res_64 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + ".txt"
	filename_fig_error = "RKA_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_fig_res = "RKA_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
elif (data_set == "ct_gaussian"):
	seed = int(sys.argv[5])
	error_folder = "errors/omp_sparse/ct_gaussian/"
	output_foler = "_gaussian/"
	filename_error_1 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_1 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_2 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_2 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_4 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_4 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_8 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_8 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_16 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_16 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_32 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_32 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_error_64 = error_folder + "RKA_csr_error_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_res_64 = error_folder + "RKA_csr_res_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig_error = "RKA_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig_res = "RKA_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
