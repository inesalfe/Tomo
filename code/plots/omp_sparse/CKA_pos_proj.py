...
if (data_set == "ct"):
	...
	filename_fig_error_1 = "CKA_pos_proj_error_1_" + str(M) + "_" + str(N) + "_" + str(max_it)
	filename_fig_error_inf = "CKA_pos_proj_error_inf_" + str(M) + "_" + str(N) + "_" + str(max_it)
	...
	filename_fig_error_1 = "CKA_pos_proj_error_1_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_error_inf = "CKA_pos_proj_error_inf_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
