...
# python3 plots/omp_sparse/CKA.py ct_gaussian 19558 16384 30000000 3
...
if (data_set == "ct"):
	...
	filename_fig_error_1 = "CKA_error_1_" + str(M) + "_" + str(N) + "_" + str(max_it)
	filename_fig_error_inf = "CKA_error_inf_" + str(M) + "_" + str(N) + "_" + str(max_it)
	...
	filename_fig_error_1 = "CKA_error_1_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_error_inf = "CKA_error_inf_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
