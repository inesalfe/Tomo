...
if (data_set == "ct"):
	...
	filename_fig_error_1 = "RKA_alpha_error_1_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads)
	filename_fig_error_inf = "RKA_alpha_error_inf_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads)
	...
	filename_fig_error_1 = "RKA_alpha_error_1_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads) + "_" + str(seed)
	filename_fig_error_inf = "RKA_alpha_error_inf_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads) + "_" + str(seed)
