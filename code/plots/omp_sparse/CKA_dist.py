...
if (data_set == "ct"):
	...
	filename_fig_error = "CKA_dist_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_fig_res = "CKA_dist_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	...
	filename_fig_error = "CKA_dist_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig_res = "CKA_dist_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
