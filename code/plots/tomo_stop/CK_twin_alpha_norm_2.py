...
# python3 plots/tomo_stop/CK_twin_alpha_norm_2.py ct_gaussian 19558 16384 30000000 2
...
if (data_set == "ct"):
	...
	filename_fig_1 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_1) + "_" + str(max_it)
	filename_fig_2 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_2) + "_" + str(max_it)
	filename_fig_3 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_3) + "_" + str(max_it)
	filename_fig_4 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_4) + "_" + str(max_it)
	filename_fig_5 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_5) + "_" + str(max_it)
	filename_fig_6 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_6) + "_" + str(max_it)
	filename_fig_7 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_7) + "_" + str(max_it)
	...
	filename_fig_1 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_1) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_2 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_2) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_3 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_3) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_4 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_4) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_5 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_5) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_6 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_6) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_7 = "CK_twin_alpha_norm_2_" + str(M) + "_" + str(N) + "_" + str(alpha_7) + "_" + str(max_it) + "_" + str(seed)
