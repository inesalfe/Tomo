...
# python3 plots/tomo_stop/SRKWOR_twin_alpha_norm_1.py ct_gaussian 19558 16384 30000000 2
...
if (data_set == "ct"):
	...
	filename_fig_1 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_1) + "_" + str(max_it)
	filename_fig_2 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_2) + "_" + str(max_it)
	filename_fig_3 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_3) + "_" + str(max_it)
	filename_fig_4 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_4) + "_" + str(max_it)
	filename_fig_5 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_5) + "_" + str(max_it)
	filename_fig_6 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_6) + "_" + str(max_it)
	filename_fig_7 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_7) + "_" + str(max_it)
	...
	filename_fig_1 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_1) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_2 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_2) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_3 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_3) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_4 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_4) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_5 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_5) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_6 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_6) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_7 = "SRKWOR_twin_alpha_norm_1_" + str(M) + "_" + str(N) + "_" + str(alpha_7) + "_" + str(max_it) + "_" + str(seed)
...
ax2.plot(it_error_twin_1, error_twin_1_1, color='purple', label=r'$\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_1_string)
...
ax2.scatter(it_error_twin_1[error_twin_1_1.index(min(error_twin_1_1))], min(error_twin_1_1), color='purple', label=r'Minimum - $\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_1_string)
print(it_error_twin_1[error_twin_1_1.index(min(error_twin_1_1))], end=' ')
print(min(error_twin_1_1))
...
ax2.plot(it_error_twin_2, error_twin_1_2, color='purple', label=r'$\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_2_string)
...
ax2.scatter(it_error_twin_2[error_twin_1_2.index(min(error_twin_1_2))], min(error_twin_1_2), color='purple', label=r'Minimum - $\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_2_string)
print(it_error_twin_2[error_twin_1_2.index(min(error_twin_1_2))], end=' ')
print(min(error_twin_1_2))
...
ax2.plot(it_error_twin_3, error_twin_1_3, color='purple', label=r'$\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_3_string)
...
ax2.scatter(it_error_twin_3[error_twin_1_3.index(min(error_twin_1_3))], min(error_twin_1_3), color='purple', label=r'Minimum - $\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_3_string)
print(it_error_twin_3[error_twin_1_3.index(min(error_twin_1_3))], end=' ')
print(min(error_twin_1_3))
...
ax2.plot(it_error_twin_4, error_twin_1_4, color='purple', label=r'$\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_4_string)
...
ax2.scatter(it_error_twin_4[error_twin_1_4.index(min(error_twin_1_4))], min(error_twin_1_4), color='purple', label=r'Minimum - $\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_4_string)
print(it_error_twin_4[error_twin_1_4.index(min(error_twin_1_4))], end=' ')
print(min(error_twin_1_4))
...
ax2.plot(it_error_twin_5, error_twin_1_5, color='purple', label=r'$\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_5_string)
...
ax2.scatter(it_error_twin_5[error_twin_1_5.index(min(error_twin_1_5))], min(error_twin_1_5), color='purple', label=r'Minimum - $\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_5_string)
print(it_error_twin_5[error_twin_1_5.index(min(error_twin_1_5))], end=' ')
print(min(error_twin_1_5))
...
ax2.plot(it_error_twin_6, error_twin_1_6, color='purple', label=r'$\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_6_string)
...
ax2.scatter(it_error_twin_6[error_twin_1_6.index(min(error_twin_1_6))], min(error_twin_1_6), color='purple', label=r'Minimum - $\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_6_string)
print(it_error_twin_6[error_twin_1_6.index(min(error_twin_1_6))], end=' ')
print(min(error_twin_1_6))
...
ax2.plot(it_error_twin_7, error_twin_1_7, color='purple', label=r'$\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_7_string)
...
ax2.scatter(it_error_twin_7[error_twin_1_7.index(min(error_twin_1_7))], min(error_twin_1_7), color='purple', label=r'Minimum - $\|\frac{1}{2}(x^{up}+x^{down})-\overline{x}\|_1$ - $%s$'%alpha_7_string)
print(it_error_twin_7[error_twin_1_7.index(min(error_twin_1_7))], end=' ')
print(min(error_twin_1_7))
