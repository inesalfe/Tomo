...
# python3 plots/tomo_stop/SRKAWOR_twin_box_proj_norm_2.py ct_gaussian 19558 16384 10000000 2
...
if (data_set == "ct"):
	...
	filename_fig_1 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_1_" + str(max_it)
	filename_fig_2 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_2_" + str(max_it)
	filename_fig_3 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_4_" + str(max_it)
	filename_fig_4 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_8_" + str(max_it)
	filename_fig_5 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_16_" + str(max_it)
	filename_fig_6 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_32_" + str(max_it)
	filename_fig_7 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_64_" + str(max_it)
	...
	filename_fig_1 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_1_" + str(max_it) + "_" + str(seed)
	filename_fig_2 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_2_" + str(max_it) + "_" + str(seed)
	filename_fig_3 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_4_" + str(max_it) + "_" + str(seed)
	filename_fig_4 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_8_" + str(max_it) + "_" + str(seed)
	filename_fig_5 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_16_" + str(max_it) + "_" + str(seed)
	filename_fig_6 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_32_" + str(max_it) + "_" + str(seed)
	filename_fig_7 = "SRKAWOR_twin_box_proj_norm_2_" + str(M) + "_" + str(N) + "_64_" + str(max_it) + "_" + str(seed)
