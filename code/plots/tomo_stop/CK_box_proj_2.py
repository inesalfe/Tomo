...
# python3 plots/tomo_stop/CK_box_proj_2.py ct_gaussian 117372 262144 500 2
...
# python3 plots/tomo_stop/CK_box_proj_2.py ct_gaussian 938720 262144 100 2
...
if (data_set == "ct"):
	output_folder = "/"
	filename_error = "errors/tomo_stop/ct/CK_box_proj_error_2_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_gauge = "errors/tomo_stop/ct/CK_box_proj_gauge_2_" + str(M) + "_" + str(N) + "_" + str(max_it) + ".txt"
	filename_fig = "CK_box_proj_2_" + str(M) + "_" + str(N) + "_" + str(max_it)
elif (data_set == "ct_gaussian"):
	seed = int(sys.argv[5])
	output_folder = "_gaussian/"
	filename_error = "errors/tomo_stop/ct_gaussian/CK_box_proj_error_2_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_gauge = "errors/tomo_stop/ct_gaussian/CK_box_proj_gauge_2_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig = "CK_box_proj_2_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
