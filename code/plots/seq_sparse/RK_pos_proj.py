...
# python3 plots/seq_sparse/RK_pos_proj.py ct 3112 484 500000
# python3 plots/seq_sparse/RK_pos_proj.py ct_gaussian 4886 1024 10000000 1
# python3 plots/seq_sparse/RK_pos_proj.py ct_poisson 4886 1024 500000 1
...
if (data_set == "ct"):
	...
	filename_fig_errors = "RK_pos_proj_errors_" + str(M) + "_" + str(N) + "_" + str(max_it)
	...
	filename_fig_errors = "RK_pos_proj_errors" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	...
	filename_res = error_folder + "RK_pos_proj_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig = "RK_pos_proj_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_errors = "RK_pos_proj_errors_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
else:
