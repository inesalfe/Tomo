...
# python3 plots/seq_sparse/RK_box_proj.py ct 3112 484 500000
# python3 plots/seq_sparse/RK_box_proj.py ct_gaussian 4886 1024 10000000 1
# python3 plots/seq_sparse/RK_box_proj.py ct_poisson 4886 1024 500000 1

# python3 plots/seq_sparse/RK_box_proj.py ct_gaussian 117372 262144 500000000 2

# 111900001 6.51962
# 112300001 1550.59
# 73100001 0.24273

# python3 plots/seq_sparse/RK_box_proj.py ct_gaussian 234664 262144 50000000 2

# 14600001 3.00696
# 14600001 788.345
# 12600001 0.0520681

# python3 plots/seq_sparse/RK_box_proj.py ct_gaussian 469368 262144 50000000 2

# 10700001 1.83609
# 10700001 512.423
# 10700001 0.0246622

# python3 plots/seq_sparse/RK_box_proj.py ct_gaussian 938720 262144 100000000 2
...
if (data_set == "ct"):
	...
	filename_fig_errors = "RK_box_proj_errors_" + str(M) + "_" + str(N) + "_" + str(max_it)
	...
	filename_fig_errors = "RK_box_proj_errors_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
