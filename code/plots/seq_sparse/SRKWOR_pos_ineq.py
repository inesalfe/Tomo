...
# python3 plots/seq_sparse/SRKWOR_pos_ineq.py ct 3112 484 500000
# python3 plots/seq_sparse/SRKWOR_pos_ineq.py ct_gaussian 4886 1024 1000000 1
# python3 plots/seq_sparse/SRKWOR_pos_ineq.py ct_poisson 4886 1024 500000 1
...
if (data_set == "ct"):
	...
	filename_fig_errors = "SRKWOR_pos_ineq_errors_" + str(M) + "_" + str(N) + "_" + str(max_it)
	...
	filename_fig_errors = "SRKWOR_pos_ineq_errors" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	...
	filename_res = error_folder + "SRKWOR_pos_ineq_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig = "SRKWOR_pos_ineq_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_errors = "SRKWOR_pos_ineq_errors_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
else:
