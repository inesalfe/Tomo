...
if (data_set == "ct"):
	...
	filename_fig_error_1 = "SRKWOR_alpha_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads)
	filename_fig_error_inf = "SRKWOR_alpha_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads)
	...
	filename_fig_error_1 = "SRKWOR_alpha_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_error_inf = "SRKWOR_alpha_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
