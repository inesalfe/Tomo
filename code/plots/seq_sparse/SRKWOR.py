...
# python3 plots/seq_sparse/SRKWOR.py ct 3112 484 500000
# python3 plots/seq_sparse/SRKWOR.py ct_gaussian 4886 1024 1000000 1
# python3 plots/seq_sparse/SRKWOR.py ct_poisson 4886 1024 500000 1

# python3 plots/seq_sparse/SRKWOR.py ct_gaussian 117372 262144 500000000 2

# 41000001 31.0039
# 41000001 9843.59
# 499000001 0.656574

# python3 plots/seq_sparse/SRKWOR.py ct_gaussian 234664 262144 200000000 2

# 17000001 12.5585
# 13000001 4781.42
# 113000001 0.20736

# python3 plots/seq_sparse/SRKWOR.py ct_gaussian 469368 262144 500000000 2

# 15000001 6.54592
# 15000001 2636.44
# 103000001 0.153955

# python3 plots/seq_sparse/SRKWOR.py ct_gaussian 938720 262144 500000000 2
...
if (data_set == "ct"):
	...
	filename_fig_errors = "SRKWOR_errors_" + str(M) + "_" + str(N) + "_" + str(max_it)
	...
	filename_fig_errors = "SRKWOR_errors_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
