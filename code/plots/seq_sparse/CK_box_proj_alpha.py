...
if (data_set == "ct"):
	...
	filename_fig_error_1 = "CK_alpha_box_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads)
	filename_fig_error_inf = "CK_alpha_box_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(threads)
	...
	filename_fig_error_1 = "CK_alpha_box_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_error_inf = "CK_alpha_box_proj_error_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
