...
if (data_set == "ct"):
    norms_folder = "outputs/omp_sparse/RowNorms_"
    output_foler = "/"
    filename_norm = norms_folder + data_set + "_" + str(M) + "_" + str(N) + ".txt"
    filename_fig = str(M) + "_" + str(N)
elif (data_set == "ct_gaussian"):
    seed = int(sys.argv[4])
    norms_folder = "outputs/omp_sparse/RowNorms_"
    output_foler = "_gaussian/"
    filename_norm = norms_folder + data_set + "_" + str(M) + "_" + str(N) + "_" + str(seed) + ".txt"
    filename_fig = str(M) + "_" + str(N) + "_" + str(seed) + ".txt"
