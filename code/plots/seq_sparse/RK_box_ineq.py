...
if (data_set == "ct"):
	...
	filename_fig_errors = "RK_box_ineq_errors_" + str(M) + "_" + str(N) + "_" + str(max_it)
	...
	filename_fig_errors = "RK_box_ineq_errors" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	...
	filename_res = error_folder + "RK_box_ineq_res_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed) + ".txt"
	filename_fig = "RK_box_ineq_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
	filename_fig_errors = "RK_box_ineq_errors_" + str(M) + "_" + str(N) + "_" + str(max_it) + "_" + str(seed)
else:
