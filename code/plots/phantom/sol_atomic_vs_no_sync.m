...
caxis manual
caxis([min_val max_val])
filename_fig = "png_gaussian/CKA_dist_atomic_" + int2str(M) + "_" + int2str(N) + "_2_" + int2str(it_max_CKA_atomic_2) + "_" + int2str(seed) + ".png";
...
caxis manual
caxis([min_val max_val])
filename_fig = "png_gaussian/CKA_dist_no_sync_" + int2str(M) + "_" + int2str(N) + "_2_" + int2str(it_max_CKA_no_sync_2) + "_" + int2str(seed) + ".png";
...
caxis manual
caxis([min_val max_val])
filename_fig = "png_gaussian/CKA_dist_atomic_" + int2str(M) + "_" + int2str(N) + "_4_" + int2str(it_max_CKA_atomic_4) + "_" + int2str(seed) + ".png";
...
caxis manual
caxis([min_val max_val])
filename_fig = "png_gaussian/CKA_dist_no_sync_" + int2str(M) + "_" + int2str(N) + "_4_" + int2str(it_max_CKA_no_sync_4) + "_" + int2str(seed) + ".png";
