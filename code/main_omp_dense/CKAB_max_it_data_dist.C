...
int main (int argc, char *argv[]) {
	...
	string filename_error = "errors/omp/CKAB_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(threads) + ".txt";
	string filename_res = "errors/omp/CKAB_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(threads) + ".txt";
