...
// ./bin/CKAB_tomo_reg.exe ct_gaussian 19558 16384 3 1 15000 500 1
// ./bin/CKAB_tomo_reg.exe ct_gaussian 19558 16384 3 2 15000 500 1
// ./bin/CKAB_tomo_reg.exe ct_gaussian 19558 16384 3 4 15000 500 1
// ./bin/CKAB_tomo_reg.exe ct_gaussian 19558 16384 3 8 15000 500 1

// ./bin/CKAB_tomo_reg.exe ct_poisson 19558 16384 3 1 15000 500 1
// ./bin/CKAB_tomo_reg.exe ct_poisson 19558 16384 3 2 15000 500 1
// ./bin/CKAB_tomo_reg.exe ct_poisson 19558 16384 3 4 15000 500 1
// ./bin/CKAB_tomo_reg.exe ct_poisson 19558 16384 3 8 15000 500 1

// ./bin/CKAB_tomo_reg.exe ct_gaussian 19558 16384 3 1 15000 300 1
// ./bin/CKAB_tomo_reg.exe ct_gaussian 19558 16384 3 2 15000 300 1
// ./bin/CKAB_tomo_reg.exe ct_gaussian 19558 16384 3 4 15000 300 1
// ./bin/CKAB_tomo_reg.exe ct_gaussian 19558 16384 3 8 15000 300 1

// ./bin/CKAB_tomo_reg.exe ct_poisson 19558 16384 3 1 15000 300 1
// ./bin/CKAB_tomo_reg.exe ct_poisson 19558 16384 3 2 15000 300 1
// ./bin/CKAB_tomo_reg.exe ct_poisson 19558 16384 3 4 15000 300 1
// ./bin/CKAB_tomo_reg.exe ct_poisson 19558 16384 3 8 15000 300 1

int main (int argc, char *argv[]) {

	if(argc != 9) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/CKAB_tomo_reg.exe <data_set> <M> <M> <seed> <threads> <it_per_thread> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = output_foler + "CKAB_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(threads) + "_" + to_string(it_per_thread) + "_" + to_string(max_it_stop) + ".txt";
	...
	string filename_res = output_foler + "CKAB_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(threads) + "_" + to_string(it_per_thread) + "_" + to_string(max_it_stop) + ".txt";
