...
// ./bin/RK_tomo_reg_sol.exe ct_gaussian 19558 16384 1 28040000
// ./bin/RK_tomo_reg_sol.exe ct_gaussian 19558 16384 2 13200000
// ./bin/RK_tomo_reg_sol.exe ct_gaussian 19558 16384 3 4470000
// ./bin/RK_tomo_reg_sol.exe ct_gaussian 19558 16384 4 1040000

// ./bin/RK_tomo_reg_sol.exe ct_poisson 19558 16384 1 1070000
// ./bin/RK_tomo_reg_sol.exe ct_poisson 19558 16384 2 3030000
// ./bin/RK_tomo_reg_sol.exe ct_poisson 19558 16384 3 5060000
// ./bin/RK_tomo_reg_sol.exe ct_poisson 19558 16384 4 4770000

int main (int argc, char *argv[]) {

	if(argc != 6) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/RK_tomo_reg_sol.exe <data_set> <M> <M> <seed> <max_it_stop>'" << endl;
		exit(1);
	}
	...
	string filename_sol = output_foler + "RK_sol_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(max_it_stop) + ".txt";
