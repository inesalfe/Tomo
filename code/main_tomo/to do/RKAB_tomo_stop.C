...
// ./bin/RKAB_tomo_stop.exe ct_error 17192 5625 50000000 100000

// ./bin/RKAB_tomo_stop.exe ct_gaussian 9786 4096 10000000 10000

// ./bin/RKAB_tomo_stop.exe ct_gaussian 19558 16384 10000000 10000

int main (int argc, char *argv[]) {

	if(argc != 11) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/RKAB_tomo_stop.exe <data_set> <M> <M> <seed> <threads> <it_per_thread> <max_it_stop> <step_save> <window_size> <tol>'" << endl;
		exit(1);
	}
