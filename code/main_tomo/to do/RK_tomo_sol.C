...
// ./bin/RK_tomo_sol.exe ct_gaussian 19558 16384 1 29840000
// ./bin/RK_tomo_sol.exe ct_gaussian 19558 16384 2 7760000
// ./bin/RK_tomo_sol.exe ct_gaussian 19558 16384 3 2220000
// ./bin/RK_tomo_sol.exe ct_gaussian 19558 16384 4 660000

// ./bin/RK_tomo_sol.exe ct_poisson 19558 16384 1 740000
// ./bin/RK_tomo_sol.exe ct_poisson 19558 16384 2 1610000
// ./bin/RK_tomo_sol.exe ct_poisson 19558 16384 3 2240000
// ./bin/RK_tomo_sol.exe ct_poisson 19558 16384 4 2440000

int main (int argc, char *argv[]) {

	if(argc != 6) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/RK_tomo_sol.exe <data_set> <M> <M> <seed> <max_it_stop>'" << endl;
		exit(1);
	}
