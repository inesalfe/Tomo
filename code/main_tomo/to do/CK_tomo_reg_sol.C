...
// ./bin/CK_tomo_reg_sol.exe ct_gaussian 19558 16384 1 12760000
// ./bin/CK_tomo_reg_sol.exe ct_gaussian 19558 16384 2 5140000
// ./bin/CK_tomo_reg_sol.exe ct_gaussian 19558 16384 3 2230000
// ./bin/CK_tomo_reg_sol.exe ct_gaussian 19558 16384 4 720000

// ./bin/CK_tomo_reg_sol.exe ct_poisson 19558 16384 1 900000
// ./bin/CK_tomo_reg_sol.exe ct_poisson 19558 16384 2 1870000
// ./bin/CK_tomo_reg_sol.exe ct_poisson 19558 16384 3 2230000
// ./bin/CK_tomo_reg_sol.exe ct_poisson 19558 16384 4 2050000

int main (int argc, char *argv[]) {

	if(argc != 6) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/CK_tomo_reg_sol.exe <data_set> <M> <M> <seed> <max_it_stop>'" << endl;
		exit(1);
	}
