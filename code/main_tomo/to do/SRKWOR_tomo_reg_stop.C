...
// ./bin/SRKWOR_tomo_reg_stop.exe ct_gaussian 19558 16384 3 10000000 10000 50 0.1
// 620000 5.45712

// ./bin/SRKWOR_tomo_reg_stop.exe ct_poisson 19558 16384 3 10000000 10000 50 0.1
// 1290000 1.57006
...
int main (int argc, char *argv[]) {
	...
	if(argc != 9) {
		...
		cout << "'./bin/SRKWOR_tomo_reg_stop.exe <data_set> <M> <M> <seed> <max_it_stop> <step_save> <window_size> <tol>'" << endl;
		exit(1);
	}
