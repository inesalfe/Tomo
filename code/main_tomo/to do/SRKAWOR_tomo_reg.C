...
// ./bin/SRKAWOR_tomo_reg.exe ct_gaussian 19558 16384 3 1 10000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_gaussian 19558 16384 3 2 10000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_gaussian 19558 16384 3 4 10000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_gaussian 19558 16384 3 8 10000000 10000

// ./bin/SRKAWOR_tomo_reg.exe ct_poisson 19558 16384 3 1 10000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_poisson 19558 16384 3 2 10000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_poisson 19558 16384 3 4 10000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_poisson 19558 16384 3 8 10000000 10000

// ./bin/SRKAWOR_tomo_reg.exe ct_gaussian 19558 16384 3 1 30000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_gaussian 19558 16384 3 2 30000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_gaussian 19558 16384 3 4 30000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_gaussian 19558 16384 3 8 30000000 10000

// ./bin/SRKAWOR_tomo_reg.exe ct_poisson 19558 16384 3 1 30000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_poisson 19558 16384 3 2 30000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_poisson 19558 16384 3 4 30000000 10000
// ./bin/SRKAWOR_tomo_reg.exe ct_poisson 19558 16384 3 8 30000000 10000

int main (int argc, char *argv[]) {

	if(argc != 8) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/SRKAWOR_tomo_reg.exe <data_set> <M> <M> <seed> <threads> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = output_foler + "SRKAWOR_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(threads) + "_" + to_string(max_it_stop) + ".txt";
	...
	string filename_res = output_foler + "SRKAWOR_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(threads) + "_" + to_string(max_it_stop) + ".txt";
	...
	while(it < max_it_stop) {
		...
		for (int i = 0; i < threads; i++) {
			line = samp_line[(threads*it+i)%M_reg];
			if (line < M) {
