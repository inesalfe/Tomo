...
// ./bin/twin_tomo.exe ct_gaussian 19558 16384 1 50 1
// ./bin/twin_tomo.exe ct_gaussian 19558 16384 2 50 1
// ./bin/twin_tomo.exe ct_gaussian 19558 16384 3 50 1
// ./bin/twin_tomo.exe ct_gaussian 19558 16384 4 50 1

// ./bin/twin_tomo.exe ct_poisson 19558 16384 1 50 1
// ./bin/twin_tomo.exe ct_poisson 19558 16384 2 50 1
// ./bin/twin_tomo.exe ct_poisson 19558 16384 3 50 1
// ./bin/twin_tomo.exe ct_poisson 19558 16384 4 50 1

// ./bin/twin_tomo.exe ct_gaussian 19558 16384 1 200 1
// ./bin/twin_tomo.exe ct_gaussian 19558 16384 2 200 1
// ./bin/twin_tomo.exe ct_gaussian 19558 16384 3 200 1
// ./bin/twin_tomo.exe ct_gaussian 19558 16384 4 200 1

// ./bin/twin_tomo.exe ct_poisson 19558 16384 1 200 1
// ./bin/twin_tomo.exe ct_poisson 19558 16384 2 200 1
// ./bin/twin_tomo.exe ct_poisson 19558 16384 3 200 1
// ./bin/twin_tomo.exe ct_poisson 19558 16384 4 200 1

int main (int argc, char *argv[]) {

	if(argc != 7) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/twin_tomo.exe <data_set> <M> <M> <seed> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
