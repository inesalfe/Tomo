...
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 1 10000000 10000
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 2 10000000 10000
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 3 10000000 10000
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 4 10000000 10000

// ./bin/RK_tomo.exe ct_poisson 19558 16384 1 10000000 10000
// ./bin/RK_tomo.exe ct_poisson 19558 16384 2 10000000 10000
// ./bin/RK_tomo.exe ct_poisson 19558 16384 3 10000000 10000
// ./bin/RK_tomo.exe ct_poisson 19558 16384 4 10000000 10000

// ./bin/RK_tomo.exe ct_gaussian 19558 16384 1 30000000 10000
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 2 30000000 10000
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 3 30000000 10000
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 4 30000000 10000

// ./bin/RK_tomo.exe ct_poisson 19558 16384 1 30000000 10000
// ./bin/RK_tomo.exe ct_poisson 19558 16384 2 30000000 10000
// ./bin/RK_tomo.exe ct_poisson 19558 16384 3 30000000 10000
// ./bin/RK_tomo.exe ct_poisson 19558 16384 4 30000000 10000

// ./bin/RK_tomo.exe ct_gaussian 19558 16384 1 50000000 10000
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 2 50000000 10000
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 3 50000000 10000
// ./bin/RK_tomo.exe ct_gaussian 19558 16384 4 50000000 10000

// ./bin/RK_tomo.exe ct_poisson 19558 16384 1 50000000 10000
// ./bin/RK_tomo.exe ct_poisson 19558 16384 2 50000000 10000
// ./bin/RK_tomo.exe ct_poisson 19558 16384 3 50000000 10000
// ./bin/RK_tomo.exe ct_poisson 19558 16384 4 50000000 10000

int main (int argc, char *argv[]) {

	if(argc != 7) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/RK_tomo.exe <data_set> <M> <M> <seed> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = output_foler + "RK_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(max_it_stop) + ".txt";
	...
	string filename_res = output_foler + "RK_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(max_it_stop) + ".txt";
