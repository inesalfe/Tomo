...
// ./bin/SRKWOR_tomo_sol.exe ct_gaussian 19558 16384 1 5280000
// ./bin/SRKWOR_tomo_sol.exe ct_gaussian 19558 16384 2 1250000
// ./bin/SRKWOR_tomo_sol.exe ct_gaussian 19558 16384 3 700000
// ./bin/SRKWOR_tomo_sol.exe ct_gaussian 19558 16384 4 180000

// ./bin/SRKWOR_tomo_sol.exe ct_poisson 19558 16384 1 500000
// ./bin/SRKWOR_tomo_sol.exe ct_poisson 19558 16384 2 990000
// ./bin/SRKWOR_tomo_sol.exe ct_poisson 19558 16384 3 1400000
// ./bin/SRKWOR_tomo_sol.exe ct_poisson 19558 16384 4 1550000

int main (int argc, char *argv[]) {

	if(argc != 6) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/SRKWOR_tomo_sol.exe <data_set> <M> <M> <seed> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
