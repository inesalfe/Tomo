...
// ./bin/mutual_tomo_reg_sol.exe ct_error 17192 5625 1000

// ./bin/mutual_tomo_reg_sol.exe ct_error 11428 2473 1000

// ./bin/mutual_tomo_reg_sol.exe ct_error 34356 5625 100

// ./bin/mutual_tomo_reg_sol.exe ct_gaussian 9786 4096 100

// ./bin/mutual_tomo_reg_sol.exe ct_gaussian 19558 16384 100

int main (int argc, char *argv[]) {

	if(argc != 6) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/mutual_tomo_reg_sol.exe <data_set> <M> <M> <seed> <max_it_stop>'" << endl;
		exit(1);
	}
