...
// ./bin/SRKABWOR_tomo_reg.exe ct_gaussian 19558 16384 3 1 15000 500 1
// ./bin/SRKABWOR_tomo_reg.exe ct_gaussian 19558 16384 3 2 15000 500 1
// ./bin/SRKABWOR_tomo_reg.exe ct_gaussian 19558 16384 3 4 15000 500 1
// ./bin/SRKABWOR_tomo_reg.exe ct_gaussian 19558 16384 3 8 15000 500 1

// ./bin/SRKABWOR_tomo_reg.exe ct_poisson 19558 16384 3 1 15000 500 1
// ./bin/SRKABWOR_tomo_reg.exe ct_poisson 19558 16384 3 2 15000 500 1
// ./bin/SRKABWOR_tomo_reg.exe ct_poisson 19558 16384 3 4 15000 500 1
// ./bin/SRKABWOR_tomo_reg.exe ct_poisson 19558 16384 3 8 15000 500 1

// ./bin/SRKABWOR_tomo_reg.exe ct_gaussian 19558 16384 3 1 15000 300 1
// ./bin/SRKABWOR_tomo_reg.exe ct_gaussian 19558 16384 3 2 15000 300 1
// ./bin/SRKABWOR_tomo_reg.exe ct_gaussian 19558 16384 3 4 15000 300 1
// ./bin/SRKABWOR_tomo_reg.exe ct_gaussian 19558 16384 3 8 15000 300 1

// ./bin/SRKABWOR_tomo_reg.exe ct_poisson 19558 16384 3 1 15000 300 1
// ./bin/SRKABWOR_tomo_reg.exe ct_poisson 19558 16384 3 2 15000 300 1
// ./bin/SRKABWOR_tomo_reg.exe ct_poisson 19558 16384 3 4 15000 300 1
// ./bin/SRKABWOR_tomo_reg.exe ct_poisson 19558 16384 3 8 15000 300 1

int main (int argc, char *argv[]) {

	if(argc != 9) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/SRKABWOR_tomo_reg.exe <data_set> <M> <M> <seed> <threads> <it_per_thread> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	while(it < max_it_stop) {
		...
		for (int i = 0; i < threads; i++) {
			...
			for (int k = 0; k < it_per_thread; k++) {
				line = samp_line[(block_begin+k)%M_reg];
				if (line < M) {
