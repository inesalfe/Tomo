...
// ./bin/mutual_tomo_stop.exe ct_gaussian 19558 16384 3 50
// 29 4.98462

// ./bin/mutual_tomo_stop.exe ct_poisson 19558 16384 3 50
// 16 4.6497
...
int main (int argc, char *argv[]) {
	...
	if(argc != 6) {
		...
		cout << "'./bin/mutual_tomo_stop.exe <data_set> <M> <M> <seed> <max_it_stop>'" << endl;
		exit(1);
	}
	...
	if (matrix_type.compare("ct_poisson") == 0) {
		...
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/mutual_tomo_stop.exe <data_set> <M> <M> <seed> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
