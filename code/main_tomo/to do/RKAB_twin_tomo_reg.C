...
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 300 1 1
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 300 2 1
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 300 4 1
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 300 8 1

// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 300 1 1
// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 300 2 1
// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 300 4 1
// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 300 8 1

// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 500 1 1
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 500 2 1
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 500 4 1
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 500 8 1

// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 500 1 1
// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 500 2 1
// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 500 4 1
// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 500 8 1

// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 750 1 1
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 750 2 1
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 750 4 1
// ./bin/RKAB_twin_tomo_reg.exe ct_gaussian 19558 16384 3 750 8 1

// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 750 1 1
// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 750 2 1
// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 750 4 1
// ./bin/RKAB_twin_tomo_reg.exe ct_poisson 19558 16384 3 750 8 1
...
int main (int argc, char *argv[]) {
	...
	if(argc != 8) {
		...
		cout << "'./bin/RKAB_twin_tomo_reg.exe <data_set> <M> <M> <seed> <max_it_stop> <threads> <step_save>'" << endl;
		exit(1);
	}
	...
	string filename_error = output_foler + "RKAB_twin_error_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(threads) + "_" + to_string(max_it_stop) + ".txt";
	...
	string filename_res = output_foler + "RKAB_twin_res_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(threads) + "_" + to_string(max_it_stop) + ".txt";
	...
	string filename_error_diff = output_foler + "RKAB_twin_error_diff_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(threads) + "_" + to_string(max_it_stop) + ".txt";
	...
	while(it < max_it_stop) {
		...
		if (it%step_save == 0) {
			...
			file_error_diff << it << " " << sqrt(sqrNormDiff(x_down, x_up, N)) << endl;
		}
	}
	file_res.close();
	file_error.close();
