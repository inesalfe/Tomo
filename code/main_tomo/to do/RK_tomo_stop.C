...
// ./bin/RK_tomo_stop.exe ct_gaussian 19558 16384 3 10000000 10000 50 0.1
// 2170000 3.80504

// ./bin/RK_tomo_stop.exe ct_poisson 19558 16384 3 10000000 10000 50 0.1
// 1880000 3.79509
...
int main (int argc, char *argv[]) {
	...
	if(argc != 9) {
		...
		cout << "'./bin/RK_tomo_stop.exe <data_set> <M> <M> <seed> <max_it_stop> <step_save> <window_size> <tol>'" << endl;
		exit(1);
	}
