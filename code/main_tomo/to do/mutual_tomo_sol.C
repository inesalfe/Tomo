...
// ./bin/mutual_tomo_sol.exe ct_error 17192 5625 500

// ./bin/mutual_tomo_sol.exe ct_error 11428 2473 500

// ./bin/mutual_tomo_sol.exe ct_error 34356 5625 500

// ./bin/mutual_tomo_sol.exe ct_gaussian 9786 4096 100

// ./bin/mutual_tomo_sol.exe ct_gaussian 19558 16384 50

int main (int argc, char *argv[]) {

	if(argc != 6) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/mutual_tomo_sol.exe <data_set> <M> <M> <seed> <max_it_stop>'" << endl;
		exit(1);
	}
	...
	string filename_sol = output_foler + "mutual_sol_" + to_string(M) + "_" + to_string(N) + "_" + to_string(seed) + "_" + to_string(max_it_stop) + ".txt";
