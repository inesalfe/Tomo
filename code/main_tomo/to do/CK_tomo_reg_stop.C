...
// ./bin/CK_tomo_reg_stop.exe ct_gaussian 19558 16384 3 10000000 10000 50 0.1
// 1150000 1.75307

// ./bin/CK_tomo_reg_stop.exe ct_poisson 19558 16384 3 10000000 10000 50 0.1
// 1400000 1.46178
...
int main (int argc, char *argv[]) {
	...
	if(argc != 9) {
		...
		cout << "'./bin/CK_tomo_reg_stop.exe <data_set> <M> <M> <seed> <max_it_stop> <step_save> <window_size> <tol>'" << endl;
		exit(1);
	}
