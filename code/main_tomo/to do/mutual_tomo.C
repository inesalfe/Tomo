...
// ./bin/mutual_tomo.exe ct_gaussian 19558 16384 1 50 1
// ./bin/mutual_tomo.exe ct_gaussian 19558 16384 2 50 1
// ./bin/mutual_tomo.exe ct_gaussian 19558 16384 3 50 1
// ./bin/mutual_tomo.exe ct_gaussian 19558 16384 4 50 1

// ./bin/mutual_tomo.exe ct_poisson 19558 16384 1 50 1
// ./bin/mutual_tomo.exe ct_poisson 19558 16384 2 50 1
// ./bin/mutual_tomo.exe ct_poisson 19558 16384 3 50 1
// ./bin/mutual_tomo.exe ct_poisson 19558 16384 4 50 1

// ./bin/mutual_tomo.exe ct_gaussian 19558 16384 1 200 1
// ./bin/mutual_tomo.exe ct_gaussian 19558 16384 2 200 1
// ./bin/mutual_tomo.exe ct_gaussian 19558 16384 3 200 1
// ./bin/mutual_tomo.exe ct_gaussian 19558 16384 4 200 1

// ./bin/mutual_tomo.exe ct_poisson 19558 16384 1 200 1
// ./bin/mutual_tomo.exe ct_poisson 19558 16384 2 200 1
// ./bin/mutual_tomo.exe ct_poisson 19558 16384 3 200 1
// ./bin/mutual_tomo.exe ct_poisson 19558 16384 4 200 1

// ./bin/mutual_tomo.exe ct_poisson 19558 16384 3 1000 1

int main (int argc, char *argv[]) {

	if(argc != 7) {
		cout << "Incorrect number of arguments: Corret usage is ";
		cout << "'./bin/mutual_tomo.exe <data_set> <M> <M> <seed> <max_it_stop> <step_save>'" << endl;
		exit(1);
	}
	...
	while(it < max_it_stop) {
		...
		for (int i = 0; i < M; i++) {
			line = i;
			scale = (b[line]-dotProductCSR(line, row_idx, cols, values_csr, kacz_down))/sqrNorm_line[line];
			scaleVecLine(line, row_idx, cols, values_csr, scale, kacz_down);	
			line = M-1-i;
			scale = (b[line]-dotProductCSR(line, row_idx, cols, values_csr, kacz_up))/sqrNorm_line[line];
			scaleVecLine(line, row_idx, cols, values_csr, scale, kacz_up);			
		}
		for (int i = 0; i < N; i++) {
