...
// ./bin/RKA_twin_tomo_reg.exe ct_gaussian 19558 16384 3 750 1 1
// ./bin/RKA_twin_tomo_reg.exe ct_gaussian 19558 16384 3 750 2 1
// ./bin/RKA_twin_tomo_reg.exe ct_gaussian 19558 16384 3 750 4 1
// ./bin/RKA_twin_tomo_reg.exe ct_gaussian 19558 16384 3 750 8 1

// ./bin/RKA_twin_tomo_reg.exe ct_poisson 19558 16384 3 750 1 1
// ./bin/RKA_twin_tomo_reg.exe ct_poisson 19558 16384 3 750 2 1
// ./bin/RKA_twin_tomo_reg.exe ct_poisson 19558 16384 3 750 4 1
// ./bin/RKA_twin_tomo_reg.exe ct_poisson 19558 16384 3 750 8 1

// ./bin/RKA_twin_tomo_reg.exe ct_gaussian 19558 16384 3 500 1 1
// ./bin/RKA_twin_tomo_reg.exe ct_gaussian 19558 16384 3 500 2 1
// ./bin/RKA_twin_tomo_reg.exe ct_gaussian 19558 16384 3 500 4 1
// ./bin/RKA_twin_tomo_reg.exe ct_gaussian 19558 16384 3 500 8 1

// ./bin/RKA_twin_tomo_reg.exe ct_poisson 19558 16384 3 500 1 1
// ./bin/RKA_twin_tomo_reg.exe ct_poisson 19558 16384 3 500 2 1
// ./bin/RKA_twin_tomo_reg.exe ct_poisson 19558 16384 3 500 4 1
// ./bin/RKA_twin_tomo_reg.exe ct_poisson 19558 16384 3 500 8 1
...
int main (int argc, char *argv[]) {
	...
	if(argc != 8) {
		...
		cout << "'./bin/RKA_twin_tomo_reg.exe <data_set> <M> <M> <seed> <max_it_stop> <threads> <step_save>'" << endl;
		exit(1);
	}
